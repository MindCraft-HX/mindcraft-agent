...
const html = renderHtml(`[打开 TODO](docs/index.md)

请查看 docs/index.md

[官网](https://example.com)`)

assert.ok(html.includes('data-path-candidate="docs/index.md"'), 'markdown local links should route through path candidate attributes')
assert.ok(/data-path-candidate="docs\/index\.md"/.test(html), 'plain strong local paths should become clickable candidates in markdown viewer output')
...
const rawHtml = renderHtml(`<script>docs/index.md</script>
...
assert.ok(rawHtml.includes('<script>docs/index.md</script>'), 'raw script contents should not be linkified')
