<template>
  <div class="status-bar-metrics">
    ...
    <div class="sb-right">
      ...
      <span v-if="finalizing" class="sb-group sb-finalizing">
        <span class="sb-dot"></span>
        <span class="sb-val">{{ t('agent.finalizing') }}</span>
      </span>
      <span v-else-if="m.thinking" class="sb-group sb-thinking">
        <span class="sb-dot"></span>
