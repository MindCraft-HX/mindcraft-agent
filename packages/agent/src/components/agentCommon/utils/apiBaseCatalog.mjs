const API_BASE_PRESETS = Object.freeze([
  ...
  { id: 'kimi-coding', agentType: 'claude', label: 'Kimi Coding', url: 'https://api.kimi.com/coding/', keywords: ['kimi', 'moonshot', '月之暗面'] },
  ...
  { id: 'kimi', agentType: 'codex', label: 'Kimi', url: 'https://api.moonshot.cn/v1', apiFormat: 'chat', keywords: ['kimi', 'moonshot', '月之暗面'] },
