...
export function hasInstructionContent(instruction) {
...
export function hasVisibleUserMessage(messages) {
...
export function isDefaultCodexDraftTitle(title) {
  const normalized = normalizeString(title)
  return normalized === '新对话' || normalized === 'New Chat'
}

export function isMeaningfulCodexLocalDraft(chatLike = {}, messages = chatLike.messages) {
...
export function isEmptyCodexLocalDraft(chatLike = {}, messages = chatLike.messages) {
