...
:deep(.hljs-keyword)  { color: var(--cc-hljs-keyword); }
:deep(.hljs-built_in) { color: var(--cc-hljs-built-in); }
:deep(.hljs-string)   { color: var(--cc-hljs-string); }
:deep(.hljs-number)   { color: var(--cc-hljs-number); }
:deep(.hljs-comment)  { color: var(--cc-hljs-comment); font-style: italic; }
:deep(.hljs-function) { color: var(--cc-hljs-function); }
:deep(.hljs-title)    { color: var(--cc-hljs-function); }
:deep(.hljs-params)   { color: var(--cc-hljs-params); }
:deep(.hljs-variable) { color: var(--cc-hljs-params); }
:deep(.hljs-attr)     { color: var(--cc-hljs-params); }
:deep(.hljs-name)     { color: var(--cc-hljs-type); }
:deep(.hljs-tag)      { color: var(--cc-hljs-tag); }
:deep(.hljs-type)     { color: var(--cc-hljs-type); }
:deep(.hljs-literal)  { color: var(--cc-hljs-tag); }
:deep(.hljs-operator) { color: var(--cc-hljs-operator); }
:deep(.hljs-punctuation) { color: var(--cc-hljs-operator); }
...
.assistant-content :deep(.md-table-wrap) {
  ...
  margin: 8px 0; border: 1px solid var(--cc-assistant-table-border); border-radius: 6px;
}
