    ...
    <div class="cc-content">
      ...
      <div class="cc-main">
        ...
        <div class="cc-input-area">
          ...
          <div class="input-box">
            <textarea
              ...
              v-model="inputText"
              class="cc-textarea"
              :placeholder="!activeProject?.cwdLocked ? $t('agent.selectFolderFirst') : (!activeTab ? $t('agent.selectOrNewChat') : (isCodexTurnLocked(activeTab) ? $t('agent.queueMsg') : $t('agent.sendMsgCodex')))"
        ...
        <StatusBarMetrics
          ...
          :finalizing="Boolean(activeTab?._awaitingDone && !activeTab?.thinking)"
