...
defineEmits(['addFile', 'triggerMention', 'triggerSlash', 'update:networkAccess', 'update:webSearch', 'update:sandboxMode', 'openPlugins', 'openSkills', 'openInstruction', 'toggleInstruction'])
</script>
