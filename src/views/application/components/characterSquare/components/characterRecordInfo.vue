        ...
        <div class="info-left">
          ...
          <div class="name-item item-label">
            ...
            <div class="item-info">
              ...
              <div class="suffix">
                <div class="mindcraft-flow-win-iconfont icon-mindcraft-fuzhi1" @click="copy(character.user_uuid)"></div>
              </div>
            </div>
          </div>
          <div class="form-item">
            ...
            <div class="tags-list">
              <div class="tag-item" v-for="item, index in character.user_tags" :key="index" :style="{ backgroundColor: tagColorList[index % tagColorList.length] }">{{ item }}</div>
            </div>
          </div>
          <div class="form-item">
            <div class="item-label">
            ...
            <div class="tags-list" v-if="character?.user_basicInfo?.personality">
              <div class="tag-item" v-for="item, index in character.user_basicInfo.personality" :key="index" :style="{ backgroundColor: tagColorList[index % tagColorList.length] }">{{ item }}</div>
            </div>
          </div>
          <div class="form-item">
            <div class="item-label">
            ...
            <div style="width: 95%" class="item-info textarea">
              <div class="textarea-text">
                {{ character?.user_basicInfo?.description || "无"}}
              </div>
            </div>
          </div>
        </div>
...
const mediaKey = computed(() => {
  return !activeIndex.value ? 'default' : 'default_gif'
})
const assestLink = computed(() => {
  const link = props?.character?.user_visualDesign?.animation_assets?.[mediaKey.value] || ""
  return link
})
</script>
