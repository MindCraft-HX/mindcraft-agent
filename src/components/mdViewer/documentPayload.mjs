...
export function createDocumentTab(payload = {}) {
  ...
  return {
    ...
    canonicalDocumentKey: String(payload.canonicalDocumentKey || ''),
    lexicalDocumentKey: String(payload.lexicalDocumentKey || ''),
    documentItemId: String(payload.documentItemId || ''),
    isLoading: false,
    isLoadError: false,
